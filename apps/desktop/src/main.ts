...
import { applyCodexPresence, applyExternalPetReaction, applyExternalPetSay, getDefaultPetPaused, installDefaultPetDisplayHandlers, isDefaultPetVisible, shouldOpenDefaultPetOnLaunch, showDefaultPet } from "./default-pet-controller.js";
...
import { startCodexPresenceWatch } from "./codex-presence.js";
...
if (!gotSingleInstanceLock) {
  ...
  app.whenReady().then(async () => {
    ...
    startCodexPresenceWatch((visible) => applyCodexPresence(visible));
